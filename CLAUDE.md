...
- `day_arc` theme is the calendar-forward sibling of `halftone`, rendered by `day_arc_panel.py` via the full-canvas `day_arc` region. Bands: a 168-px dithered ribbon, a 32-px paper-white axis strip, a 6-px Bayer rule, then a 274-px body (agenda left, supporting rail right, footer). Notable points:
