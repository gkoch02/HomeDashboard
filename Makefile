...
previews: _check-venv
	...
	@for theme in agenda air_quality day_arc default diags fantasy fuzzyclock fuzzyclock_invert halftone minimalist moonphase moonphase_invert moonphase_photo naturalist old_fashioned postcard qotd qotd_invert terminal timeline today trends weather year_pulse; do \
