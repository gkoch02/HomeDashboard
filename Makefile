...
previews: _check-venv
	@for theme in air_quality default diags fantasy fuzzyclock fuzzyclock_invert minimalist moonphase moonphase_invert newspaper old_fashioned qotd qotd_invert terminal timeline today weather year_pulse; do \
